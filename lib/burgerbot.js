 ...
 *      dbPath : the path to access the database (will default to "data/burgerbot.db")
 *
...
var BurgerBot = function Constructor(settings) {
    ...
    this.dbPath = settings.dbPath || path.resolve(__dirname, '..', 'data', 'burgerbot.db');
 ...
 * @private
 */
BurgerBot.prototype._replyWithRandomJoke = function (originalMessage) {
    var self = this;
 ...
 * @private
 */
BurgerBot.prototype._connectDb = function () {
 ...
 * @private
 */
BurgerBot.prototype._firstRunCheck = function () {
    var self = this;
 ...
 * @private
 */
BurgerBot.prototype._welcomeMessage = function () {
...
/**
 * Util function to check if a given real time message is mentioning Chuck Norris or the burgerbot
 * @param {object} message
 * @returns {boolean}
 * @private
 */
BurgerBot.prototype._isMentioningChuckNorris = function (message) {
